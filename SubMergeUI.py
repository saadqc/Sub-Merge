...
"color: rgb(247, 247, 247);"))
        ...
        self.actionAuto_select_subtitle = QtGui.QAction(MainWindow)
        self.actionAuto_select_subtitle.setObjectName(_fromUtf8("actionAuto_select_subtitle"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionConcatenate.setShortcut(_translate("MainWindow", "Ctrl+Shift+C", None))
        ...
        self.actionSet_to_Current_Position.setShortcut(_translate("MainWindow", "Ctrl+D", None))
        self.actionBreak_Selected_Subtitles.setText(_translate("MainWindow", "Create Tab (Selected Subtitles)", None))
        self.actionBreak_Selected_Subtitles.setShortcut(_translate("MainWindow", "Ctrl+T", None))
        # self.actionSave.setText(_translate("MainWindow", "Save", None))
        # self.actionSave.setShortcut(_translate("MainWindow", "Ctrl+S", None))
        self.actionSave_As.setText(_translate("MainWindow", "Save As..", None))
        self.actionAbout.setText(_translate("MainWindow", "About", None))
        self.actionAuto_select_subtitle.setText(_translate("MainWindow", "Auto select subtitle", None))
